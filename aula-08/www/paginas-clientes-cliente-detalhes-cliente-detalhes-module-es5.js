(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["paginas-clientes-cliente-detalhes-cliente-detalhes-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPaginasClientesClienteDetalhesClienteDetalhesPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPaginasClientesClienteDetalhesClienteDetalhesRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ClienteDetalhesPageRoutingModule", function () {
        return ClienteDetalhesPageRoutingModule;
      });
      /* harmony import */
      ...
      var _cliente_detalhes_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./cliente-detalhes.page */
      ...
      var ClienteDetalhesPageRoutingModule = function ClienteDetalhesPageRoutingModule() {
        _classCallCheck(this, ClienteDetalhesPageRoutingModule);
      };

      ClienteDetalhesPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppPaginasClientesClienteDetalhesClienteDetalhesModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ClienteDetalhesPageModule", function () {
        return ClienteDetalhesPageModule;
      });
      /* harmony import */
      ...
      var _cliente_detalhes_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./cliente-detalhes-routing.module */
      "./src/app/paginas/clientes/cliente-detalhes/cliente-detalhes-routing.module.ts");
      /* harmony import */


      var _cliente_detalhes_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./cliente-detalhes.page */
      "./src/app/paginas/clientes/cliente-detalhes/cliente-detalhes.page.ts");

      var ClienteDetalhesPageModule = function ClienteDetalhesPageModule() {
        _classCallCheck(this, ClienteDetalhesPageModule);
      };

      ClienteDetalhesPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _cliente_detalhes_routing_module__WEBPACK_IMPORTED_MODULE_5__["ClienteDetalhesPageRoutingModule"]],
    ...
    /***/
    function srcAppPaginasClientesClienteDetalhesClienteDetalhesPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPaginasClientesClienteDetalhesClienteDetalhesPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ClienteDetalhesPage", function () {
        return ClienteDetalhesPage;
      });
      /* harmony import */
      ...
      var ClienteDetalhesPage = /*#__PURE__*/function () {
        function ClienteDetalhesPage(alerta, routeActive, router, clienteService) {
          var _this = this;

          _classCallCheck(this, ClienteDetalhesPage);
          ...
          this.id = null;
          this.id = this.routeActive.snapshot.paramMap.get('id'); // this.id = Number(this.id);
          ...
          */
          ...
          this.clienteService.getClienteById(this.id).then(function (cliente) {
            _this.cliente = {
              id: cliente.id,
              nome: cliente.nome,
              email: cliente.email,
        ...
        _createClass(ClienteDetalhesPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "iniciarEdicao",
          value: function iniciarEdicao() {
            this.modoEdicao = true; // this.copy(this.clienteAux, this.cliente);
          ...
          value: function deletar() {
            ...
            this.clienteService.deletar(this.cliente.id).then(function () {
              _this2.router.navigateByUrl('/clientes-lista');
            });
          }
        }, {
          key: "editar",
          value: function editar() {
            ...
            this.clienteService.atualizar(this.cliente).then(function () {
              _this3.router.navigateByUrl('/clientes-lista');
          ...
          key: "cancelarEdicao",
          value: function cancelarEdicao() {
            console.log('cliente', this.cliente);
            console.log('clienteAux', this.clienteAux); // this.copy(this.cliente, this.cliente);
      ...
      ClienteDetalhesPage.ctorParameters = function () {
        return [{
      ...
      ClienteDetalhesPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-cliente-detalhes',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./cliente-detalhes.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/paginas/clientes/cliente-detalhes/cliente-detalhes.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./cliente-detalhes.page.scss */
        "./src/app/paginas/clientes/cliente-detalhes/cliente-detalhes.page.scss"))["default"]]
      })], ClienteDetalhesPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=paginas-clientes-cliente-detalhes-cliente-detalhes-module-es5.js.map