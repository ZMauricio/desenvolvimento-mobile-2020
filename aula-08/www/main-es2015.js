...
const routes = [
    ...
    {
        path: 'login',
        loadChildren: () => __webpack_require__.e(/*! import() | paginas-login-login-module */ "paginas-login-login-module").then(__webpack_require__.bind(null, /*! ./paginas/login/login.module */ "./src/app/paginas/login/login.module.ts")).then(m => m.LoginPageModule)
    },
    {
        path: 'lista-servicos',
        loadChildren: () => __webpack_require__.e(/*! import() | paginas-lista-servicos-lista-servicos-module */ "paginas-lista-servicos-lista-servicos-module").then(__webpack_require__.bind(null, /*! ./paginas/lista-servicos/lista-servicos.module */ "./src/app/paginas/lista-servicos/lista-servicos.module.ts")).then(m => m.ListaServicosPageModule),
        canActivate: [_guards_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    },
    {
        path: 'servicos-detalhes/:id',
        loadChildren: () => __webpack_require__.e(/*! import() | paginas-servicos-detalhes-servicos-detalhes-module */ "paginas-servicos-detalhes-servicos-detalhes-module").then(__webpack_require__.bind(null, /*! ./paginas/servicos-detalhes/servicos-detalhes.module */ "./src/app/paginas/servicos-detalhes/servicos-detalhes.module.ts")).then(m => m.ServicosDetalhesPageModule)
    },
    {
        path: 'admin',
        loadChildren: () => Promise.all(/*! import() | paginas-admin-admin-module */[__webpack_require__.e("common"), __webpack_require__.e("paginas-admin-admin-module")]).then(__webpack_require__.bind(null, /*! ./paginas/admin/admin.module */ "./src/app/paginas/admin/admin.module.ts")).then(m => m.AdminPageModule),
        canActivate: [_guards_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    },
    {
        path: 'cliente-detalhes/:id',
        loadChildren: () => Promise.all(/*! import() | paginas-clientes-cliente-detalhes-cliente-detalhes-module */[__webpack_require__.e("common"), __webpack_require__.e("paginas-clientes-cliente-detalhes-cliente-detalhes-module")]).then(__webpack_require__.bind(null, /*! ./paginas/clientes/cliente-detalhes/cliente-detalhes.module */ "./src/app/paginas/clientes/cliente-detalhes/cliente-detalhes.module.ts")).then(m => m.ClienteDetalhesPageModule)
    },
    {
        path: 'clientes-lista',
        loadChildren: () => Promise.all(/*! import() | paginas-clientes-clientes-lista-clientes-lista-module */[__webpack_require__.e("common"), __webpack_require__.e("paginas-clientes-clientes-lista-clientes-lista-module")]).then(__webpack_require__.bind(null, /*! ./paginas/clientes/clientes-lista/clientes-lista.module */ "./src/app/paginas/clientes/clientes-lista/clientes-lista.module.ts")).then(m => m.ClientesListaPageModule)
    },
    {
        path: 'cliente-novo',
        loadChildren: () => Promise.all(/*! import() | paginas-clientes-cliente-novo-cliente-novo-module */[__webpack_require__.e("common"), __webpack_require__.e("paginas-clientes-cliente-novo-cliente-novo-module")]).then(__webpack_require__.bind(null, /*! ./paginas/clientes/cliente-novo/cliente-novo.module */ "./src/app/paginas/clientes/cliente-novo/cliente-novo.module.ts")).then(m => m.ClienteNovoPageModule)
    }
];
...
/* harmony import */ var _angular_fire__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/fire */ "./node_modules/@angular/fire/__ivy_ngcc__/es2015/index.js");
...
/* harmony import */ var _angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/fire/auth-guard */ "./node_modules/@angular/fire/__ivy_ngcc__/auth-guard/es2015/index.js");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_9__["AngularFireModule"].initializeApp(_credentials__WEBPACK_IMPORTED_MODULE_13__["firebaseConfig"]),
...
let AuthGuardService = class AuthGuardService {
    constructor(router, autenticacao) {
        this.router = router;
...
module.exports = __webpack_require__(/*! D:\WorkApplications\EnsinoCodes\Desenv_Mobile\aula-mobile-08-fotos\src\main.ts */"./src/main.ts");
