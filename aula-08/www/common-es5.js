  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function srcAppServicesClientesServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ClientesService = /*#__PURE__*/function () {
        ...
        function ClientesService(firestore) {
        ...
        _createClass(ClientesService, [{
          ...
          value: function atualizar(cliente) {
            ...
            return this.firestore.doc("clientes/".concat(cliente.id)).update(cliente);
          }
        }, {
          key: "cadastrar",
          value: function cadastrar(cliente) {
            delete cliente.id;
          ...
          value: function getClienteById(id) {
            return this.firestore.collection('clientes').doc(id).ref.get().then(function (cliente) {
              if (cliente.exists) {
                var dadosCliente = cliente.data();
          ...
          value: function deletar(id) {
            return this.firestore.doc("clientes/".concat(id))["delete"]();
          }
        }]);
